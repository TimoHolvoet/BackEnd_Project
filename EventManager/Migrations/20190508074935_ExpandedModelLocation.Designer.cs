...
namespace EventManager.API.Migrations
{
    ...
    [Migration("20190508074935_ExpandedModelLocation")]
    partial class ExpandedModelLocation
    {
            ...
            modelBuilder.Entity("EventManager.WebApp.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("03b9408d-6d68-443c-9061-35636d9e2ead"),
                            Capacity = 1000,
                            Date = new DateTime(2019, 5, 8, 0, 0, 0, 0, DateTimeKind.Local),
                            Description = "EventDescription1",
                            Genre = "EventGenre1",
                            ImageUrl = "Fakelink1.png",
                            LocationId = new Guid("31086ff7-f452-4028-b8f7-5b9251ef1684"),
                            Name = "EventName1",
                            SoldTickets = 400
                        });
                });
            ...
            modelBuilder.Entity("EventManager.WebApp.Models.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("31086ff7-f452-4028-b8f7-5b9251ef1684"),
